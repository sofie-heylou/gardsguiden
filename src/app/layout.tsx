...
const DESCRIPTION =
  "Hitta gårdsbutiker och köp lokala råvaror direkt från bonden i Stockholm, Uppsala, Västmanland och Södermanland. 176 verifierade gårdar med kött, grönsaker, mejeriprodukter, honung och mer.";
