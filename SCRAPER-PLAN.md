...
- [ ] Tune until it matches human judgment. Two rounds done against cached pages (mjölkautomat, bigård, uppfödning, familjedriven gård, English-language sites…; false contradictions Bjällansås gård and two vineyards fixed). **Sofie's review of the report is the gate that remains.**
